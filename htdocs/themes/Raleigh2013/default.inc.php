  ...
  <div id="container"><!-- Hack for footer lock -->
	...
	<section id="main_content" role="main">
		...
		<footer id="page_footer">
			<div class="nest">
				<p class="legalese">
					All user-contributed content is, of course, owned by its authors. The Raleigh code
					is owned by the citizens of Raleigh and, consequently, it is not governed by
